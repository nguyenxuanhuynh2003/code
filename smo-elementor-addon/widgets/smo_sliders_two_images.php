<?php
class Elementor_Sliders_Two extends \Elementor\Widget_Base {

	public function get_name() {
		return 'smo_sliders_two';
	}

	public function get_title() {
		return esc_html__( 'Smo Sliders Two', 'elementor-addon' );
	}
	...
	protected function render() {
		...
		<?php
			...
			//var_dump($item['image']);
			?>
				<div class="slider_two_item">
					<div class="slider_two_inner">
						<img src="<?php echo  $item['list_image']['url']; ?>" alt="" />
						<div class="wrap_content">
							<h3><?php echo $item['list_title']; ?></h3>
							<p><?php echo $item['list_des'] ?></p>
						</div>
					</div>
				</div>
		...
		<div class="custom-control center <?php echo $class ?>">
